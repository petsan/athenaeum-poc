...
- Before marking any task "done," run the actual test suite
  (`pytest -q`, currently 516 collected; last full live run 515 passed + 1 skipped — the skip is the
  GPU-worker test when no worker is online — on 2026-09-26, `docs/progress.md` §66) and update `docs/progress.md` — don't
