...
2. **`known-bugs.md`** — twenty-five real bugs hit during development (plus a list of open known limitations), each
...
- Before marking any task "done," run the actual test suite
  (`pytest -q`, currently 440 collected; last fully-green live run was 362 passed + 1 skipped on
  2026-09-26 before the OLMo 3 guest degraded — see `docs/progress.md` §48–54 for the offline runs since) and update `docs/progress.md` — don't
