...
- Before marking any task "done," run the actual test suite
  (`pytest -q`, currently 500 collected; last full live run 498 passed + 1 skipped + 1 known-flaky failure (known-bugs.md open limitations) — the skip is the
  GPU-worker test when no worker is online — on 2026-09-26, `docs/progress.md` §62) and update `docs/progress.md` — don't
